...
# Create a counts file with counts from genes and putative_sRNAs
system("( cat output_BH_5_10/gene_Counts.csv ; tail -n +2 output_BH_5_10/putative_sRNA_Counts.csv; ) | cat > output_BH_5_10/allCounts.csv")

#Call differential_expression() function
de.res <- differential_expression(feature_count_file="output_BH_5_10/allCounts.csv", metadata_file=system.file("extdata", "conditions.txt", package="baerhunter"), cutoff_value=10, multiple_variables=FALSE, main_condition="condition", output_file_name="output_BH_5_10/allCounts_diff_expression.csv")
